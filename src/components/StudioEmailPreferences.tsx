...
const StudioEmailPreferences: React.FC = () => {
  ...
  const updatePreferencesAsync = async (key: keyof StudioEmailPreferences, value: boolean, newPreferences: StudioEmailPreferences) => {
    try {
      setSaving(true);
      await StudioEmailPreferencesService.updateSpecificPreference(user!.uid, key, value);
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Receive a weekly summary of your activity and popular streams
            </p>
          </div>
          <Switch
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Receive important account and system-related notifications
            </p>
          </div>
          <Switch
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-800 dark:text-blue-200 mt-1">
                ...
                System notifications are recommended to stay enabled for important account updates.
              </p>
            </div>
          </div>
        </div>
...
export default StudioEmailPreferences;
