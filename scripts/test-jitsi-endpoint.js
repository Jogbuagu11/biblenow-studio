...
/**
 * Test script for Jitsi JWT endpoint
 * Tests both local and production endpoints
 */

const fetch = require('node-fetch');

async function testJitsiEndpoint() {
  console.log('🧪 Testing Jitsi JWT Endpoint...\n');
  ...
  console.log('   - Local endpoint should work if server is running');
  console.log('   - Production endpoint should work if deployed to Render');
