-- Fix Weekly Usage Recording
-- This migration fixes issues with weekly usage not being recorded properly
...
-- 2. Create the improved function with better logging and error handling
