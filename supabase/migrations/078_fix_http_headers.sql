-- Update the trigger function with correct http_request format
...
BEGIN
    ...
    request_url := CONCAT(supabase_url, '/functions/v1/send-streaming-limit-email');
    ...
    IF usage_percentage >= 75 AND usage_percentage < 100 THEN
        ...
        -- Call edge function to send warning email using http_post
        ...
        FROM extensions.http_post(
            ...
            'application/json',
            ARRAY[
                extensions.http_header('Authorization', CONCAT('Bearer ', service_role_key)),
