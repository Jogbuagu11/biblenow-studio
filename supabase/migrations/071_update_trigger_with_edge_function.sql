-- Update the streaming limit notification function to call edge function
...
BEGIN
    ...
    IF usage_percentage >= 75 AND usage_percentage < 100 THEN
        ...
        PERFORM net.http_post(
            url := CONCAT(current_setting('app.settings.supabase_url'), '/functions/v1/send-streaming-limit-email'),
