-- Fix Livestream Notification Infrastructure
-- This script creates a proper notification system for streaming limit emails

-- ========================================
-- STEP 1: Clean up existing broken triggers
-- ========================================

-- Drop all existing broken triggers and functions
DROP TRIGGER IF EXISTS streaming_limit_notification_trigger ON public.livestream_weekly_usage;
DROP TRIGGER IF EXISTS streaming_limit_notification_trigger ON public.livestreams;
DROP FUNCTION IF EXISTS notify_streaming_limit_status();

-- ========================================
-- STEP 2: Create proper notification table
-- ========================================
...
DO $$
BEGIN
    RAISE NOTICE 'Livestream notification infrastructure has been fixed!';
